...
public class UserTypeDAO {
     ...
     */
    private List<UserType> getUserTypes (String select_query) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                user_types.add(new UserType(usertypeID, usertypename, createdAT, updatedAT, deletedAT));
            }
    ...
    public boolean softDeleteUserType (UserType usertype) {
        Connection connection = ConnectionSingleton.getInstance();
        try {
