...
public class ChatBot {
    ...
    public ChatBot (Integer chatbotID, Integer ownerFK, Integer enterPoint, Integer endPoint, String name, String welcome, Date createdAt, Date updatedAt, Date deletedAt) {
    ...
    public String toString () {
        return "ChatBot [chatbot_ID =" + chatbotID + ", owner_FK =" + ownerFK + ", name =" + name + ", welcome =" + welcome +
