...
public class ChatBots {
	...
	public ChatBots(Integer chatbotID, Integer ownerFK, Integer enterPoint, Integer endPoint, String name,
			String welcome, Date createdAt, Date updatedAt, Date deletedAt) {
	...
	public String toString() {
		return "ChatBots [chatbotID=" + chatbotID + ", ownerFK=" + ownerFK + ", enterPoint=" + enterPoint
				+ ", endPoint=" + endPoint + ", name=" + name + ", welcome=" + welcome + ", createdAt=" + createdAt
