...
public class BotMessagesController implements Controller {
    ...
    public void doControl(Request request) {
        ...
        switch (choice) {
		case 1:
			MainDispatcher.getInstance().callView("BotMessagesRead", null);
			break;
		case 2:
			MainDispatcher.getInstance().callView("BotMessagesInsert", null);
			break;
		case 3:
			MainDispatcher.getInstance().callView("BotMessagesUpdate", null);
			break;
		case 4:
			MainDispatcher.getInstance().callView("BotMessagesDelete", null);
			break;
		default:
